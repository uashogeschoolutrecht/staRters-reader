---
title: "Why use R?"
subtitle: "An introduction to data analysis with R for StaRters"
...
## Disclaimer
 ...
 - I will show you some 'statistical examples'
 - I can not learn you R programming in 3 days
 - R programming is not equal to learning another software tool
 - There are more materials in the course repository than we can cover in three days
 - **I encourage you to join the Peer Support Group Data Science after this course, so we can really dive deeply into all the topics you are interested in!**
